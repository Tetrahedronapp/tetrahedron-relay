...
function corsHeaders(req: Request): Record<string, string> {
  ...
  // Anthropic and OpenAI SDKs add telemetry headers (x-stainless-os,
  // x-stainless-lang, …) that change between SDK versions; hardcoding
  // a list is brittle. Safe to echo because auth is validated via
  // AUTH_TOKEN, not header presence.
